//
//  Doxycycline100mgViewController.m
//  Rat Dosage Calculator
//
//  Created by Liana Chu on 2/12/15.
...
@interface Doxycycline100mgViewController ()
...
@implementation Doxycycline100mgViewController

-(id)init
{
    self = [super init];
    if (self) {
        self.tabBarItem.title = @"Doxy";
        UIImage *image = [UIImage imageNamed:@"DoxyTabBarIcon.png"];
...
{
    UILabel *label = [[UILabel alloc] init];
    label.text = @"This calculator is for Doxycycline 100mg capsules or packets. Doses are calculated at 10mg/kg. Mix the powder into 5mL of syrup. The calculated dose should be given twice a day. Mix well before each use.";
...
-(void)calculateButtonWasTapped
{
    ...
    if (textFieldText.length > 0) {
        ...
        float calculatedDoseFloat = [Doxy100mgCalculator doseOfDoxy100InmLCalculatedFromWeight:floatValue];
